...
like_dislike.ig <- graph_from_data_frame(got_like_dislike)
```
...
Once again, we find more distributed and mutual relationships in the random network than in the Game of Thrones like_disklike network. It is likely that we'd find more brokerage relationships in the random network as well.
